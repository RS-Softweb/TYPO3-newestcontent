...
/**
 * Test case for class Tx_Newestcontent_Controller_ContentController.
 *
 * @version $Id$
 ...
 */
class Tx_Newestcontent_Controller_ContentControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
